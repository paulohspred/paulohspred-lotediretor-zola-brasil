...
rows(source_code, source_type, authority, dataset_code, access_class, parser_version, cadence, ingestion_status) AS (
  VALUES
    ...
    ('PMSP_TERRITORIO_TOPOGRAFIA','WFS/DOWNLOAD','Prefeitura de São Paulo','TOPOGRAFIA_MUNICIPAL','B','topografia-terrain-v1','por publicação','healthy'),
    ('PMSP_SISTEMA_VIARIO','WFS','Prefeitura de São Paulo','SEGMENTO_LOGRADOURO','B','sistema-viario-segmento-v1','conforme cadastro','healthy'),
