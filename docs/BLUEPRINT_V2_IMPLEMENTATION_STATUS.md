...
- Plano Diretor consome, via proxy same-origin read-only, a evidência factual versionada da LPUOS e as sobreposições de zoneamento calculadas para o imóvel ativo; exibe fonte/hash/citação e método sem converter a sobreposição geométrica, isoladamente, em conclusão jurídica ou parâmetro construtivo.
